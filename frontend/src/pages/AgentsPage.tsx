    ...
    <div className="p-6 max-w-6xl mx-auto">
      <div className="flex items-baseline justify-between mb-6">
        ...
        <div className="flex gap-2 text-xs">
          <span className="text-emerald-400">{summary.ok ?? 0} ok</span>
          <span className="text-amber-400">{summary.warning ?? 0} warning</span>
          <span className="text-rose-400">{summary.critical ?? 0} critical</span>
        </div>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {agents.map((a) => {
          ...
          return (
            <div
              key={a.agent_name}
              className="rounded-lg border border-slate-700 bg-slate-900/50 p-4 flex flex-col gap-2 cursor-pointer hover:border-slate-500"
            ...
            >
              ...
              <button
                className="mt-1 self-start rounded bg-slate-700 px-2 py-1 text-xs hover:bg-slate-600 disabled:opacity-50"
