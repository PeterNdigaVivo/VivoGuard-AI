        ...
        section_table(
            ...
            [
                ...
                ["briefings.daily_fire_due", "5 min",
                 "Calculates the legacy 08:00 store-local briefing; external delivery is disabled"],
                ["briefings.weekly_fire_due", "5 min",
                 "Calculates the legacy Monday 07:00 chain summary; external delivery is disabled"],
            ],
